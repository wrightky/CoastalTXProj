#!/usr/bin/env python
"""
File defines the callable class for the coastal TX coordinate transform
"""
import numpy as np
import xarray as xr
import matplotlib
...
class CoasTX_Projection():
    ...
    def __init__(self):
        ...
        ds = xr.open_dataset(os.path.join(loc,r'transform_grid.nc'))
    ...
    def __call__(self, coordinates):
        ...
        Note that coordinates expected in [x,y] order, i.e. [longitude, latitude], and
        longitude is assumed to be in degrees West (e.g. -98 to -92 degrees)
